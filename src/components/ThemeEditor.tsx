...
const ThemeEditor: React.FC<ThemeEditorProps> = ({
  ...
  return (
    <div className={`h-screen p-4 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      <div className="max-w-2xl mx-auto">
        <button
          onClick={() => setCurrentPage('dashboard')}
          className={`mb-2 ${isDarkMode ? 'text-blue-400 hover:text-blue-300' : 'text-brown-600 hover:text-brown-700'} flex items-center`}
        >
        ...
        <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg p-4 shadow-lg space-y-4`}>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full p-1 rounded text-sm ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}
                >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => onThemeChange({ ...currentTheme, buttonStyle: e.target.value })}
                  className={`w-full p-1 rounded text-sm ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}
                >
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) => onThemeChange({ ...currentTheme, animationSpeed: parseInt(e.target.value) })}
                    className="w-full"
                  />
              ...
              <div>
                ...
                <select
                  value={currentTheme.iconSet}
                  onChange={(e) => onThemeChange({ ...currentTheme, iconSet: e.target.value })}
                  className={`w-full p-1 rounded text-sm ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}
                >
          ...
          <button
            onClick={() => setCurrentPage('dashboard')}
            className={`w-full ${isDarkMode ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'} text-white font-bold py-2 px-4 rounded mt-4`}
          >
            {t.saveChanges}
          </button>
        </div>
